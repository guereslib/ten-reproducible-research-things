...
{% capture text %}{% include icon.html icon='person-exclamation' %} A key person from your research team has disappeared (family, personal emergency or no longer contactable). 
